...
class ThemeCrew:
    ...
    def AI_summary(self, issues):
        ...
        inquiry_resolution = Task(
                    ...
                    expected_output=(
                        "A categorized list of JIRA Server tickets grouped by their root cause or area of concern. If multiple groups have been made that is fine."
                        ...
                        "Your response should be in HTML text. Follow the rough format below. In the format below there can be multiple groups with different themes and more/less than two tickets per group. Fill in the necessary information:\n"
        "<li>"
        "<strong>Group 1: [theme]</strong>"
        "<ul>"
        "    <li>"
        "        <strong>Summary:</strong> [summary of the theme]"
        "    </li>"
        "    <li>"
        "        <strong>Tickets:</strong>"
        "        <ul>"
        "            <li>"
        "                <strong><a href=https://issues.onenetwork.com/browse/[key]>[key]</a:</strong>"
        "                <ul>"
        ...
        "</li>"
                        ...
                        "Also ensure that the response is in HTML format. Make sure that each part of each ticket (like summary, description, etc.) gets its own bullet point."
                    ),
                    agent=senior_researcher_agent,
                )
        crew = Crew(
